...
# rule: output of interface 1 of SUME of node95 to eth21 on node98
ovs-ofctl add-flow br0 priority=10,in_port=7,udp,nw_dst=224.3.29.73,udp_dst=34952,action=output:24
# rule: output of interface 1 of SUME of node96 to eth21 on node98
ovs-ofctl add-flow br0 priority=10,in_port=15,udp,nw_dst=224.3.29.73,udp_dst=34952,action=output:24
# rule: output of interface 1 of SUME of node98 to eth21 on node98
ovs-ofctl add-flow br0 priority=10,in_port=16,udp,nw_dst=224.3.29.73,udp_dst=34952,action=output:24
